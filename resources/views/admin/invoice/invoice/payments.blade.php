        ...
        <div class="widget-content widget-content-area">
            <form method="POST" id="submitForm" enctype="multipart/form-data">
                ...
                <div class="col-lg-12 col-12 mt-5 ">
                    <div class="row">
                        <input type="hidden" name="inv_id" value="{{$invoices->id}}">
                        ...
                        <div class="form-group col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 text-right" id="due_amount_labl">
                            <label for="exampleFormControlInput2"
                                class="font-weight-bold text-black text-right text-uppercase">Sub Total</label>
                        </div>

                        <div class="form-group col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" id="due_amount_div">
                            <input type="text" name="sub_total" id="sub_total" value="{{ number_format($invoices->sub_total,2,'.','')}}" readonly
                                class="form-control price text-right font-weight-bold text-black">

                            <span class="text-danger font-weight-bold error_sub_total"></span>
                        </div>
                        ...
                        <div class="form-group col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" id="due_amount_div">
                            <input type="text" name="discount_amount" id="discount_amount" value="{{number_format($invoices->disc_amount,2,'.','')}}" readonly
                                class="form-control price text-right font-weight-bold text-black">
                        ...
                        <div class="form-group col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" id="due_amount_div">
                            <input type="text" name="total" id="total" value="{{number_format($invoices->total,2,'.','')}}" readonly
                                class="form-control price text-right font-weight-bold text-black">

                            <span class="text-danger font-weight-bold error_total"></span>
                        </div>

                        @php
                            $total = $invoices->total;
                            $paid_amount = $invoices->invoicePayment->sum('amount');
        ...
        $(document).ready(function() {
            ...
            $(function() {
                $('#data_table').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: '{!! url('/admin/invoices/invoices/get_payments/' . $invoices->id) !!}',
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                            orderable: false,
            ...
            $('#submitForm').submit(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('/admin/invoices/invoices/store_payments') }}",
                    data: formData,
                    dataType: "JSON",
                    contentType: false,
                    cache: false,
            ...
            buttons: {
                confirm: {
                    ...
                    action: function() {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "{{ url('/admin/invoices/invoices/delete_payments') }}",
                            data: data,
                            success: function(response) {
                                location.reload();
                            }
