            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12 text-center">
                        <h3 class="p-4 font-weight-bold text-uppercase">Create New Expense </h3>
                    </div>
                </div>
            </div>
                                ...
                                <div class="form-group mb-4">
                                    <label for="exampleFormControlInput2">Month<span
                                            ...
                                            <select name="month" class="form-control disabled-results">
                                                <option value=""></option>
                                                @for ($i = 1; $i <=12; $i++)
                                                    <option value="{{$i}}" {{date('m') == $i ? 'selected' : ''}}>{{date('F', strtotime('2023-'.$i))}}</option>
                                                @endfor
                                            </select>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="date" name="paid_date" class="form-control price"
                                         min="{{date('Y-m-d')}}" value="{{date('Y-m-d')}}" id="exampleFormControlInput2">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="amount" class="form-control price"
                                        value="{{ old('amount') }}" maxlength="10" id="exampleFormControlInput2">
        ...
        $(document).ready(function() {
            ...
            $('#submitForm').submit(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('/admin/accounts/expense/create') }}",
                    data: formData,
                    dataType: "JSON",
                    contentType: false,
                    cache: false,
