                ...
                <form method="POST" id="categoryCreateForm" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12 col-12 mt-5 ">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group mb-4">
                                    <label for="exampleFormControlInput2">Upload Category Image <small class="text-info">(Dimensions (190px x
                                        190px))</small> <span
                                        class="text-danger">*</span></label>
                                        <div class="upload">
                                            <input type="file" name="category_image" id="input-file-max-fs" class="dropify"
                                                {{-- data-default-file="{{ asset(Auth::user()->UserProfile->profile) }}" --}}
                            ...
                            <div class=" col-lg-12 col-12 border-top">
                                <div class="row mt-3">
                                        ...
                                        <div>
                                            <label class="switch s-icons s-outline  s-outline-success  mb-4 mr-2">
                                                <input type="checkbox" name="is_home" onclick='handleClick(this);'
                                                    @if (old('is_home') == true) checked @endif>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="banner_div col-lg-12" id="banner_div" style="display: none">
                                        <div class="row">
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" name="banner_title" class="form-control"
                                                        value="{{ old('banner_title') }}" id="exampleFormControlInput2">
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group mb-4">
                                                        ...
                                                        <label for="exampleFormControlInput2">Upload banner Image <small class="text-info">(Dimensions (900px x
                                                            300px))</small> <span
                                                            class="text-danger">*</span></label>
                                                            <div class="upload">
                                                                <input type="file" name="banner_image" id="input-file-max-fs" class="dropify"
                                                                    {{-- data-default-file="{{ asset(Auth::user()->UserProfile->profile) }}" --}}
                                                                    data-max-file-size="4M" accept="image/*" />
                                                            </div>
                                                        <span
                                                            class="text-danger font-weight-bold error_banner_image"></span>
