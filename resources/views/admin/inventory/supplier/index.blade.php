...
@section('content')
    @if (count($suppliers))
        <div class="col-lg-12 col-12  layout-spacing">
            <a href="{{ url('admin/inventory/suppliers/create') }}" class="btn btn-theme float-right text-uppercase">
                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 ">
                            <h3 class="font-weight-bold pt-2 pb-2 text-uppercase">Suppliers</h3>
                        </div>
                    </div>
                </div>
        ...
        $(document).ready(function () {
            ...
            function loadDatas()
            {
                table =  $('#data_table').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{!! url('/admin/inventory/get_suppliers') !!}",
                        data: function (d) {
                                d.status = $('.status').val()
                            }
                        },
    ...
    <script>
        function deleteConfirmation(id) {
            ...
            $.confirm({
                ...
                title: 'Are you Sure!',
                content: 'Do you want to Delete the Selected Suppliers?',
                type: 'red',
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function() {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "{{ url('/admin/inventory/suppliers/delete/') }}" + "/" + id,
                                data: data,
