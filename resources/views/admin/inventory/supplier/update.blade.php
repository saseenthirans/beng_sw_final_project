            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12 text-center">
                        <h3 class="p-4 font-weight-bold text-uppercase">Update Supplier </h3>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="supplier_name" class="form-control"
                                        value="{{ $supplier->name }}" id="exampleFormControlInput2">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="address" class="form-control"
                                        value="{{ $supplier->address }}" id="exampleFormControlInput2">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="email" name="email" class="form-control"
                                        value="{{ $supplier->email }}" id="exampleFormControlInput2">
                            ...
                            <div class="form-group col-lg-6 col-12">
                                ...
                                <div>
                                    <label class="switch s-icons s-outline  s-outline-success  mb-4 mr-2">
                                        <input type="checkbox" name="status" {{$supplier->status == 1 ? 'checked' : ''}}>
        ...
        $(document).ready(function() {
            ...
            $('#submitForm').submit(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('/admin/inventory/suppliers/update') }}",
                    data: formData,
                    dataType: "JSON",
                    contentType: false,
                    cache: false,
