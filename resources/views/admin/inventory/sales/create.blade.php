            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12 text-center">
                        <h3 class="p-4 font-weight-bold text-uppercase">Create New Sale </h3>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <select name="product_id" class="form-control disabled-results product_id">
                                        ...
                                        @foreach ($inventory as $item)
                                            <option class="ml-4" value="{{ $item->id }}">{{ $item->code.' - ' . $item->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="selling_price" class="form-control selling_price text-black"
                                        value="{{ old('selling_price') }}" readonly id="exampleFormControlInput2">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="date" name="start_date" min="{{date('Y-m-d')}}" class="form-control"
                                        value="{{ old('start_date') }}" id="exampleFormControlInput2">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="date" name="end_date" min="{{date('Y-m-d')}}" class="form-control"
                                        value="{{ old('end_date') }}" id="exampleFormControlInput2">
        ...
        $(document).ready(function() {
            ...
            $('#submitForm').submit(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('/admin/inventory/sales/create') }}",
                    data: formData,
                    dataType: "JSON",
                    contentType: false,
                    cache: false,
