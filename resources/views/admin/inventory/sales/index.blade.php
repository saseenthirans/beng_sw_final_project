...
@section('content')
    @if (count($sales))
        <div class="col-lg-12 col-12  layout-spacing">
            <a href="{{ url('admin/inventory/sales/create') }}" class="btn btn-theme float-right text-uppercase">
                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 ">
                            <h3 class="font-weight-bold pt-2 pb-2 text-uppercase">sales</h3>
                        </div>
                    </div>
                </div>
        ...
        $(document).ready(function() {
            ...
            function loadData() {
                table = $('#data_table').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{!! url('/admin/inventory/get_sales') !!}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                            orderable: false,
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function() {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "{{ url('/admin/inventory/sales/delete/') }}" + "/" + id,
                                data: data,
                                success: function(response) {
                                    location.href = "{{ url('/admin/inventory/sales') }}";
                                }
                            });
                        }
                    },
