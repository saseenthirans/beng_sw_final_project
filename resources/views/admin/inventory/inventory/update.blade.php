            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12 text-center">
                        <h3 class="p-4 font-weight-bold text-uppercase">Update Inventory </h3>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="product_code" class="form-control"
                                        value="{{ $inventory->code }}" id="exampleFormControlInput2">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="product_name" class="form-control"
                                        value="{{ $inventory->name }}" id="exampleFormControlInput2">
                                        ...
                                        @foreach ($categories as $item)
                                            <optgroup label="{{$item->name}}">
                                                @foreach ($item->activeSubCategory as $acItem)
                                                    <option class="ml-4" value="{{ $acItem->id }}" {{$inventory->category_id == $acItem->id ? 'selected':''}}>{{ $acItem->name }}</option>
                                                @endforeach
                                            </optgroup>
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="selling_price" class="form-control"
                                        value="{{ $inventory->price }}" id="exampleFormControlInput2">
                            ...
                            <div class="col-lg-12 col-12">
                                <div class="form-group mb-4">
                                    <label for="exampleFormControlInput2">Sort Description<span
                                            class="text-danger">*</span></label>
                                    <textarea name="sort_description" class="form-control" rows="3">{{$inventory->description}}</textarea>
                            ...
                            <div class="col-lg-12 col-12">
                                <div class="form-group mb-4">
                                    <label for="exampleFormControlInput2">Full Description<span
                                            class="text-danger">*</span></label>
                                        <textarea name="full_description" class="form-control summernote" rows="3">{{$inventory->full_description}}</textarea>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="upload">
                                        <input type="file" name="image" id="input-file-max-fs" class="dropify"
                                         data-default-file="{{ asset($inventory->image) }}" data-max-file-size="4M" accept="image/*" />
                                    </div>
                            ...
                            <div class="form-group col-lg-6 col-12">
                                ...
                                <div>
                                    <label class="switch s-icons s-outline  s-outline-success  mb-4 mr-2">
                                        <input type="checkbox" name="status" {{$inventory->status == 1 ? 'checked' : ''}} >
        ...
        $(document).ready(function() {
            ...
            $('#submitForm').submit(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('/admin/inventory/inventories/update') }}",
                    data: formData,
                    dataType: "JSON",
                    contentType: false,
                    cache: false,
