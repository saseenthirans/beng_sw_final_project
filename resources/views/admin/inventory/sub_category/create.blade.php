    ...
    <div class="col-lg-12 col-12 layout-spacing">
        <div class="col-lg-6 col-6">
            <div class="form-group mb-4">
                <a href="{{ url('admin/inventory/subcategories') }}"
            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12 text-center">
                        <h3 class="p-4 font-weight-bold text-uppercase">Create New Sub Category </h3>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12 col-12 mt-5 ">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group mb-4">
                                    <label for="exampleFormControlInput2">Sub Category Name<span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="sub_category_name" class="form-control"
                                        value="{{ old('sub_category_name') }}" id="exampleFormControlInput2">

                                    <span class="text-danger font-weight-bold error_sub_category_name"></span>
                                </div>
                            </div>
        ...
        $(document).ready(function() {
            ...
            $('#submitForm').submit(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('/admin/inventory/subcategories/create') }}",
                    data: formData,
                    dataType: "JSON",
                    contentType: false,
                    cache: false,
