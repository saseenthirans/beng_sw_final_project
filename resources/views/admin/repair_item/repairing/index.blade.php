...
@section('content')
    @if (count($repairing))
        <div class="col-lg-12 col-12  layout-spacing">
            <a href="{{ url('admin/repair_items/repairing/create') }}" class="btn btn-theme float-right text-uppercase">
                <i class="fa fa-plus"></i> Create New Repairing
            </a>
        </div>
                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 ">
                            <h3 class="font-weight-bold pt-2 pb-2 text-uppercase">Repairing Details</h3>
                        </div>
                    </div>
                </div>
        ...
        $(document).ready(function() {
            ...
            $('#btn_export').click(function(e) {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: "{{ url('/admin/repair_items/repairing/export') }}",
                    data: data,
    ...
    <script>
        function deleteConfirmation(id) {
            ...
            $.confirm({
                ...
                title: 'Are you Sure!',
                content: 'Do you want to Delete the Selected Repairing? If you delete you will lost the Related Repairing Data and Inventory will update',
                type: 'red',
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function() {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "{{ url('/admin/repair_items/repairing/delete') }}",
                                data: data,
                                success: function(response) {
                                    location.href = "{{ url('/admin/repair_items/repairing') }}";
                                }
                            });
                        }
                    },
