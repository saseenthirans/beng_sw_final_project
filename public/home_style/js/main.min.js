...
$.extend($.easing, {
  ...
  var e, i, a, n, o, s, r;
  (Wolmart.$window = t(window)), (Wolmart.$body = t(
    document.body
  )), (Wolmart.status = ""), (Wolmart.isIE =
    navigator.userAgent.indexOf("Trident") >= 0), (Wolmart.isEdge =
    navigator.userAgent.indexOf("Edge") >=
    0), (Wolmart.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
    navigator.userAgent
    ...
    var a = new Date();
    a.setTime(a.getTime() + 24 * i * 60 * 60 * 1e3), (document.cookie =
    ...
    return (s.val = a(function r(l) {
      n ||
        (n = o = l), !i || l - n < i ? (l - o > e ? (t(), (s.val = a(r)), (o = l)) : (s.val = a(r))) : t();
    })), console.log(s), s;
    ...
    Wolmart.$body
      .on("click", ".tab .nav-link", function(e) {
        ...
        if ((e.preventDefault(), !i.hasClass("active"))) {
          var a = t(i.attr("href"));
          a.siblings(".active").removeClass("in active"), a.addClass(
            "active in"
          ), i
            .parent()
            .parent()
            .find(".active")
            .removeClass("active"), i.addClass("active");
        }
      })
    ...
    return e == Wolmart.resizeTimeStamp ||
      (
        void 0 === window.innerHeight &&
          (window.innerWidth = t(window).width() + Wolmart.getScrollbarWidth()),
    ...
    if (void 0 === Wolmart.scrollbarSize) {
      ...
      (t.style.cssText =
        ...
        t.offsetWidth - t.clientWidth), document.body.removeChild(t);
    }
    ...
    return (e.prototype.init = function(e, i) {
      (this.$el = e), (this.options = t.extend(
        !0,
        {},
        Wolmart.stickyDefaultOptions,
        i,
      ...
      this.isWrap
        ? e || this.unwrap()
        : e && this.wrap(), (Wolmart.sticky_top_height = 0), t &&
        setTimeout(this.refreshSize.bind(this), 50);
    ...
    t.fn.themePluginParallax &&
      Wolmart.$(e).each(function() {
        ...
        e.themePluginParallax(
          t.extend(!0, Wolmart.parseOptions(e.attr("data-parallax-options")), i)
        );
      });
    ...
    t.fn.parallax &&
      Wolmart.$(".floating-item").each(function(e) {
        ...
        i.data("parallax") &&
          ...
          ), i.children().addClass("layer").attr("data-depth", i.attr("data-child-depth")), i.parallax(Wolmart.parseOptions(i.data("options")));
      });
    ...
    if ("function" == typeof imagesLoaded && t.fn.isotope) {
      ...
      Wolmart.$(e).each(function() {
        ...
        Wolmart.lazyLoad(e), e.imagesLoaded(function() {
          n.customInitHeight && e.height(e.height()), n.customDelay &&
    ...
    t.fn.isotope &&
      Wolmart.$(e).on("click", function(e) {
        ...
        t(n || ".grid")
          ...
          .siblings()
          .children()
          .removeClass("active"), i.addClass("active"), e.preventDefault();
      });
    ...
    for (
      ...
      e[n].addEventListener("mouseover", a), e[
        n
      ].addEventListener("touchstart", a, { passive: !0 });
    ...
    Wolmart.$(e).each(function() {
      ...
      -1 != i.indexOf("%")
        ...
        : -1 != i.indexOf("/") &&
          (a =
            (a = parseInt(i.split("/")[0]) / parseInt(i.split("/")[1]) * 100)
              .toFixed(2)
              .toString() + "%"), e.find("span").css("width", a);
    });
    ...
    Wolmart.$body.on("click", e, function(e) {
      ...
      e.preventDefault(), 0 === o.find(".collapsing").length &&
        ...
        if (e.classList.contains("appear-animate")) {
          ...
          setTimeout(function() {
            (e.style["animation-duration"] =
              i.duration), e.classList.add(i.name), e.classList.add("appear-animation-visible");
      ...
      !t(".sticky-sidebar > .filter-actions").length &&
        ...
        t(".sticky-content.fix-top").each(function(e) {
          if (!t(this).hasClass("sticky-toolbox")) {
            ...
            (i += t(this).addClass("fixed").outerHeight()), a ||
    ...
    }),
    {
      init: function() {
        ...
        (i.className = "minipopup-area"), Wolmart.byClass(
          "page-wrapper"
        )[0].appendChild(i), (e = t(i)), (this.close = this.close.bind(
          this
        )), (r = r.bind(this));
      },
      open: function(n, l) {
        ...
        u.length &&
          u.on("load", function() {
            (i +=
              c[0].offsetHeight +
              d.space), c.addClass("show"), c.offset().top - window.pageYOffset < 0 && (d.close(), c.css("top", -i + c[0].offsetHeight + d.space)), c
              ...
              c
            ), o.length || (s = setInterval(r, 200)), o.push(p.delay), l && l(c);
          });
      },
      close: function(t) {
        var e = void 0 === t ? 0 : t,
    ...
    if ("number" == typeof e) o = e;
      ...
      var o = n.offset().top,
        s = t("#wp-toolbar");
      window.innerWidth > 600 && s.length && (o -= s.parent().outerHeight()), t(
  ...
  var e = function(t) {
    ...
    a = {
      ...
      initMobileMenu: function() {
        ...
        }), t(".mobile-menu-toggle").on("click", e), t(
          ".mobile-menu-overlay"
        ).on("click", i), t(".mobile-menu-close").on(
          "click",
          i
      ...
      initFilterMenu: function() {
        t(".search-ul li").each(function() {
          if (this.lastElementChild && "UL" === this.lastElementChild.tagName) {
            ...
            (t.className = "la la-angle-down"), this.classList.add(
              "with-ul"
          ...
          t(this)
            ...
            .slideToggle(300)
            .parent()
            .toggleClass("show"), e.preventDefault();
        });
      },
        ...
        t(".widget-collapsible .widget-title").each(function() {
          ...
          i.hasClass("collapsed") ||
            a.css(
              "display",
              "block"
            ), a.stop().slideToggle(300), i.toggleClass("collapsed"), setTimeout(function() {
  ...
  var i = function(t) {
    ...
    n = function(e) {
      ...
      i.find(".swiper-slide:not(.swiper-slide-active) video").each(function() {
        this.paused ||
          i.trigger("autoplayStart"), this.pause(), (this.currentTime = 0);
      }), a.length &&
        (
    ...
    r = function(e) {
      var i = this,
        a = t(this.wrapperEl);
      (i.translateFlag = 1), (i.prev = i.next), a
        .find(".swiper-slide .slide-animate")
        .each(function() {
          var e = t(this),
            i = t.extend(
              !0,
        ...
        if (
          ...
          a.find(".swiper-slide-active .slide-animate").each(function() {
            ...
            e.css(
              "animation-duration",
              n
            ), e.css("animation-delay", o), e.css("transition-property", "visibility, opacity"), e.css("transition-delay", o), e.css("transition-duration", n), e.addClass(s), (n = n || "0.75s");
            var r = Wolmart.requestTimeout(function() {
              e.css(
                "transition-property",
                ""
              ), e.css("transition-delay", ""), e.css("transition-duration", ""), e.addClass("show-content"), i.timers.splice(i.timers.indexOf(r), 1);
            }, o
  ...
  (e.defaults = { slidesPerView: 1, speed: 300 }), (e.presets = {
    ...
    (this.timers = []), (this.translateFlag = 0), (this.prev = 0), (this.next = 0), (this.container =
      c[0]), (this.wrapperEl = c.children()[0]);
    ...
    if (!c.data("slider")) {
      ...
      f.forEach(function(i) {
        ...
        t.extend(!0, g, { navigation: { nextEl: p[0] } }), u.length &&
        t.extend(!0, g, { navigation: { prevEl: u[0] } }), m.length &&
        t.extend(!0, g, { pagination: { el: m[0], clickable: !0 } }), c
        .find("video")
        .each(function() {
          this.loop = !1;
        }), t.extend(
        ...
        d
      ), i.call(this), (this.slider = new Swiper(this.container, g)), c.data(
        "slider",
        this.slider
      ), c.trigger("initialized.slider", this.slider), this.slider
        .on("afterInit", a)
        .on("transitionEnd", n), c.hasClass("animation-slider") &&
        o.call(this), c.hasClass("animation-slider") &&
        this.slider
          .on("resize", s)
          .on("transitionStart", r.bind(this))
          .on("transitionEnd", l.bind(this)), h.length &&
        (
          this.slider.on("transitionEnd", function() {
            var t = this.activeIndex;
            h
              .children("a:nth-child(" + ++t + ")")
              .addClass("active")
              .siblings()
              .removeClass("active");
          }),
  ...
  (e.prototype.init = function(e) {
    var a = this;
    return (a.name = e), (a.$sidebar = t("." + e)), (a.isNavigation = !1), a
      .$sidebar.length &&
      (
        (a.isNavigation =
            ...
            (
              ...
              e.$sidebar
                ...
                .animate(
                  ...
                  function() {
                    t(this).css("margin-bottom", ""), a &&
                      e.$sidebar.find(".filter-clean").fadeIn("fast");
                  }
                )
            ),
  ...
  var e = {
    init: function() {
      var e;
      Wolmart.call(Wolmart.ratingTooltip, 500), Wolmart.call(
        Wolmart.setProgressBar(".progress-bar"),
        500
      ), this.initVariation(), this.initProductsScrollLoad(
        ".scroll-load"
      ), Wolmart.$body
        .on("mousedown", ".select-menu", function(e) {
          var i = t(e.currentTarget),
            a = t(e.target),
            n = i.hasClass("opened");
          t(".select-menu").removeClass("opened"), i.is(a.parent())
                ...
                a.parent().hasClass("active")
                  ...
                  : t(".selected-items > .selected-item")
                      ...
                      .fadeOut(function() {
                        t(
                          this
                        ).remove(), t(".selected-items").children().length < 2 && t(".selected-items").hide();
                      })
              );
        })
        ...
        t(e.currentTarget).parent().fadeOut(function() {
          ...
          i &&
            i.toggleClass(
              "active"
            ), e.remove(), t(".select-items").children().length < 2 && t(".select-items").hide();
        }), e.preventDefault();
        ...
        "click",
        ".product:not(.product-select) , .product-popup , .home .product-single ",
        function(e) {
          e.preventDefault();
          var i = t(this),
          ...
          i.hasClass("disabled")
            ...
            : (
                ...
                setTimeout(function() {
                  ...
                  ), Wolmart.Minipopup.open({ productClass: " product-cart", name: a.find(".product-name, .product-title").text(), nameLink: a.find(".product-name > a, .product-title > a").attr("href"), imageSrc: a.find(".product-media img, .product-image:first-child img").attr("src"), imageLink: a.find(".product-name > a").attr("href"), message: "<p>has been added to cart:</p>", actionTemplate: '<a href="cart.html" class="btn btn-rounded btn-sm">View Cart</a><a href="checkout.html" class="btn btn-dark btn-rounded btn-sm">Checkout</a>' });
                }, 500)
              );
        }
      ), Wolmart.$body.on(
        ...
        function(e) {
          ...
          i
            .toggleClass("added")
            .addClass("load-more-overlay loading"), setTimeout(function() {
            i.removeClass(
              "load-more-overlay loading"
        ...
        a.length ||
          ...
          .on("click", ".product .btn-compare", function(o) {
            var s = t(this);
            s.hasClass("added") &&
              returne(), o.preventDefault(), s.toggleClass("added").addClass("load-more-overlay loading"), setTimeout(function() {
              s.removeClass(
                "load-more-overlay loading"
              ), s.toggleClass("w-icon-compare").toggleClass("w-icon-check-solid"), s.attr("href", "compare.html"), a.addClass("show");
            }, 500);
            var r = s.closest(".product").find("img").eq(0).attr("src");
            i.length >= 4 && i.shift(), i.push(r), t(
              ".compare-popup li"
            ).each(function(t) {
              i[t] &&
                (this.innerHTML =
          ...
          .on("click", ".compare-popup .btn-clean", function(a) {
            a.preventDefault(), t(
              ...
              0,
              4
            ), (e = i.length), t(this).parent().find(".compare-product-list li").empty(), n();
    ...
    initVariation: function(e) {
      t(
        ".product:not(.product-single) .product-variations > a"
      ).on("click", function(e) {
        var i = t(this),
        ...
        a.data("image-src") ||
          a.data(
            "image-src",
            a.attr("src")
          ), i.toggleClass("active").siblings().removeClass("active"), i.hasClass("active") ? a.attr("src", i.data("src")) : (a.attr("src", a.data("image-src")), i.blur()), e.preventDefault();
      });
    },
      ...
      var o = function(e) {
        window.pageYOffset > i + a.outerHeight() - window.innerHeight - 150 &&
          ...
          t.ajax({
            ...
            success: function(e) {
              var i = t(e);
              a.data("load-state", "loading"), a
                .next()
                .hasClass("load-more-overlay")
                ? a.next().addClass("loading")
                : t(
                    '<div class="mt-4 mb-4 load-more-overlay loading"></div>'
                  ).insertAfter(a), setTimeout(function() {
                a
                  .next()
                  .removeClass("loading"), a.append(i), setTimeout(function() {
  ...
  (e.min = 1), (e.max = 1e6), (e.value = 1), (e.prototype.init = function(t) {
    var i = this;
    (i.$minus = !1), (i.$plus = !1), (i.$value = !1), (i.value = !1), (i.startIncrease = i.startIncrease.bind(
      i
    )), (i.startDecrease = i.startDecrease.bind(i)), (i.stop = i.stop.bind(
      i
    )), (i.min = parseInt(t.attr("min"))), (i.max = parseInt(
      t.attr("max")
    )), i.min || t.attr("min", (i.min = e.min)), i.max ||
      t.attr("max", (i.max = e.max)), (i.$value = t.val(
      (i.value = e.value)
    )), (i.$minus = t
      .parent()
      .find(".quantity-minus")
      ...
      .on("mouseup", i.stop)), Wolmart.$body
      .on("mouseup", i.stop)
      .on("touchend", i.stop)
    ...
    t && t.preventDefault();
    var e = this;
    (e.value = e.$value.val()), e.value > e.min &&
      e.$value.val(
        --e.value
      ), (e.decreaseTimer = Wolmart.requestTimeout(function() {
      (e.speed = 1), (e.decreaseTimer = Wolmart.requestInterval(function() {
        e.$value.val(
          (e.value = Math.max(e.value - Math.floor((e.speed *= 1.05)), e.min))
        );
      }, 50));
    }, 400));
  }), (e.prototype.stop = function(t) {
    Wolmart.deleteTimeout(this.increaseTimer), Wolmart.deleteTimeout(
      this.decreaseTimer
    );
  ...
  (e.defaults = {
    ...
    callbacks: {
      open: function() {
        t("html").css("overflow-y", "hidden"), t("body").css(
          "overflow-x",
          "visible"
        ), t(".mfp-wrap").css("overflow", "hidden auto"), t(
          ".sticky-header.fixed"
        ).css("padding-right", window.innerWidth - document.body.clientWidth);
      },
      close: function() {
        t("html").css("overflow-y", ""), t("body").css(
          "overflow-x",
          "hidden"
        ), t(".mfp-wrap").css("overflow", ""), t(".sticky-header.fixed").css(
          "padding-right",
          ""
        );
      }
    ...
    n.isOpen
      ...
      : t.magnificPopup.open(
        ...
        ), Wolmart.$body.on("mousedown", ".mfp-wrap", o), "ontouchstart" in
      document && document.addEventListener("touchstart", o, { passive: !0 });
  ...
  var i = function() {
    ...
    n = function(e) {
      e.preventDefault(), Wolmart.scrollTo(
        t(
  ...
  (e.prototype.init = function(e) {
    ...
    (o.$wrapper = e), (o.isQuickView = !!e.closest(".mfp-content")
      .length), (o._isPgVertical = !1), o.isQuickView &&
      ((i = i.bind(this)), Wolmart.ratingTooltip()), (function(t) {
      (t.$thumbs = t.$wrapper.find(
        ".product-thumbs"
      )), (t.$thumbsWrap = t.$thumbs.parent()), (t.$thumbUp = t.$thumbsWrap.find(
        ".thumb-up"
      )), (t.$thumbDown = t.$thumbsWrap.find(
        ".thumb-down"
      )), (t.$thumbsDots = t.$thumbs.children()), (t.thumbsCount =
        t.$thumbsDots.length), (t.$productThumb = t.$thumbsDots.eq(
        0
      )), (t._isPgVertical = t.$thumbsWrap
        .parent()
        .hasClass("product-gallery-vertical")), (t.thumbsIsVertical =
        t._isPgVertical && window.innerWidth >= 992), Wolmart.slider(
        t.$thumbsWrap,
        {},
        !0
      );
    })(o), document.body.classList.contains("home") ||
      (s.parent().hasClass("product-gallery-video") &&
        ...
        )), o.$wrapper.on("click", ".btn-wishlist", a), o.$wrapper.on(
      "click",
      ".rating-reviews",
      n
    ), "complete" === Wolmart.status &&
      (
        Wolmart.slider(s, { thumbs: { swiper: o.$thumbsWrap.data("slider") } }),
      ...
      (e.$selects = e.$wrapper.find(
        ...
        t(this)
          ...
          .removeClass(
            "active"
          ), i.preventDefault(), e.variationCheck(), e.$items.parent(".product-image-swatch") && e.swatchImage();
    ...
    t.$priceWrap
      .find("span")
      .text(
        "$" + (Math.round(50 * Math.random()) + 200) + ".00"
      ), t.$priceWrap.slideDown(), t.$clean.slideDown(), t.$btnCart.removeClass(
      "disabled"
    );
  }), (e.prototype.variationClean = function(t) {
    t && this.$selects.val(""), t &&
      this.$items
        .children(".active")
        .removeClass("active"), this.$priceWrap.slideUp(), this.$clean.css(
      "display",
      "none"
    ...
    a
      .addClass("active")
      .siblings(".active")
      .removeClass("active"), (this.isStickyScrolling = !0);
    var o = a
    ...
    t.preventDefault(), Wolmart.popup(
      {
        items: {
          src:
            '<video src="assets/video/memory-of-a-woman.mp4" autoplay loop controls>',
          type: "inline"
        },
  ...
  function a(e) {
    var i = t(this);
    i.addClass("active").siblings().removeClass("active"), i
      .parent()
      .addClass("selected"), i
      .closest(".rating-form")
      .find("select")
      .val(i.text()), e.preventDefault();
  }
  function n(e) {
    var i = t(this),
  ...
  Wolmart.initProductSinglePage = function() {
    t(".product-gallery").each(function() {
      ...
      function o() {
        i.hasClass("fix-top") &&
          window.innerWidth > 767 &&
          i.removeClass("fix-top").addClass("fix-bottom"), (i.hasClass(
          "fix-bottom"
        ) &&
          window.innerWidth > 767) ||
          (
      ...
      i
        .find(".product-qty-form")
        .before(n), window.addEventListener("resize", o, { passive: !0 }), o();
    })(".product-sticky-content"), document.body.classList.contains("home") ||
      Wolmart.$body
        .on("click", ".product-image-full", e)
        .on("click", ".review-image img", e)
        .on("click", ".product-video-viewer", i)
        .on("click", ".product-degree-viewer", function(e) {
          e.preventDefault(e), t.fn.ThreeSixty &&
            (function(t) {
              t.preventDefault(), Wolmart.popup({
                type: "inline",
                ...
                items: {
                  src:
                    '<div class="product-gallery-degree">\t\t\t\t\t\t<div class="w-loading"><i></i></div>\t\t\t\t\t\t<ul class="product-degree-images"></ul>\t\t\t\t\t</div>'
                },
                callbacks: {
                  open: function() {
                    this.container
        ...
        .on("click", ".product-single:not(.product-popup)", n);
  };
})(jQuery), (function(t) {
  Wolmart.initCodePopup = function() {
    t(".box-btn.showcode span").each(function() {
      ...
      e.hasClass("enabled")
        ...
        : (
            ...
            t(".show-code-action").each(function() {
              ...
              (i.className =
                "show-code"), i.appendChild(document.createTextNode("</>")), this.appendChild(i), setTimeout(function() {
      ...
      if (i.hasClass("show-code-added")) {
        ...
        i[0].removeChild(a), t(".code-popup #textareaCode").text(
          i.data("codepopup")
        ), t(".code-copy a").html(
          ...
          }), t(".CodeMirror").remove(), CodeMirror.fromTextArea(document.getElementById("textareaCode"), { mode: "text/html", htmlMode: !0, lineWrapping: !1, smartIndent: !1, spellcheck: !0, addModeClass: !0, readOnly: !0 });
        }, 100), i[0].appendChild(a);
      }
    }), Wolmart.$body.on("mouseenter mouseleave", ".show-code-action", function(
      t
    ) {
      t.stopPropagation();
    });
  ...
  var i = function(t) {
    ...
    (i += e.settings.displayYear ? " " + t.getFullYear() : ""), e.element
      .find(".calendar-title")
      .html(i);
  };
  (e.defaultOptions = {
    ...
    var o = this;
    (o.element = a), (o.settings = t.extend(
      {},
      !0,
      e.defaultOptions,
      Wolmart.parseOptions(a.attr("data-calendar-options")),
      n
    )), (o.today = new Date()), (i = i.bind(this));
    ...
    for (var h = c; h < d; h.setDate(h.getDate())) {
      ...
      for (u = 0; u < 7; u++) {
        ...
        h.toDateString() == new Date().toDateString() &&
          g.find(".day").addClass("today"), h.getMonth() != e.getMonth() &&
          g.find(".day").addClass("disabled"), f.append(g), h.setDate(
          h.getDate() + 1
        );
      }
      s.append(f);
    ...
    this.today.setMonth(this.today.getMonth() + e, 1), this.render(
      this.today,
    ...
    a.on("click", function(t) {
      ...
      e.hasClass("open")
        ...
        : e.addClass("open").slideDown(), t.preventDefault();
    }), n.on("click", function() {
    ...
    i.find(".check-seller").on("click", function() {
      i
        ...
        .addClass(
          "active"
        ), i.find("#check-customer").removeClass("active"), a.slideDown();
    }), n.on("click", function() {
      i
        .find("#check-customer")
        .addClass(
          "active"
        ), i.find("#check-seller").removeClass("active"), a.slideUp();
    });
  });
})(jQuery), jQuery, (Wolmart.initLayout = function() {
  Wolmart.isotopes(".grid:not(.grid-float)"), Wolmart.stickySidebar(
    ".sticky-sidebar"
  );
}), (Wolmart.init = function() {
  Wolmart.appearAnimate(".appear-animate"), Wolmart.setTab(
    ".nav-tabs"
    ...
    ".parallax"
  ), Wolmart.skrollrParallax(), Wolmart.initFloatingParallax(), Wolmart.menu.init(), Wolmart.initScrollTopButton(), Wolmart.shop.init(), Wolmart.alert(
    ".alert"
  ), Wolmart.closeTopNotice(".banner-close"), Wolmart.accordion(
    ".card-header > a"
  ), Wolmart.sidebar("sidebar"), Wolmart.sidebar(
    "right-sidebar"
  ), Wolmart.productSingle(
    ".product-single"
  ), Wolmart.initProductSinglePage(), Wolmart.initQtyInput(
    ".quantity"
  ), Wolmart.initNavFilter(".nav-filters .nav-filter"), Wolmart.calendar(
    ".calendar-container"
  ), Wolmart.countDown(
    ".product-countdown, .countdown"
  ),  Wolmart.initCartAction(
    ".cart-offcanvas .cart-toggle"
  ), Wolmart.Minipopup.init(), Wolmart.headerToggleSearch(
    ".hs-toggle"
  ), Wolmart.initVendor(".store"), Wolmart.slideContent(
    ".login-toggle"
  ), Wolmart.slideContent(".coupon-toggle"), Wolmart.slideContent(
    ".checkbox-toggle"
  ), Wolmart.initLoginVendor(
    ".user-checkbox"
  ), Wolmart.initCodePopup(), Wolmart.slider(".swiper-container"), Wolmart.call(
    Wolmart.slider.pgToggle
  ), Wolmart.$window.on("resize", function() {
    Wolmart.call(Wolmart.slider.pgToggle);
  });
}), jQuery, (window.onload = function() {
  (Wolmart.canvasWidth =
    window.innerWidth), (Wolmart.resizeTimeStamp = 0), (Wolmart.resizeChanged = !1), (Wolmart.status =
    "loaded"), document.body.classList.add("loaded"), Wolmart.call(
    Wolmart.initLayout
  ), Wolmart.call(Wolmart.init), (Wolmart.status =
    "complete"), Wolmart.$window.trigger("wolmart_complete");
});
